...
public class ClearSlotPageStorageR extends Function {
    ...
    public ClearSlotPageStorageR() {
        super("ClearSlotPageStorageR".toUpperCase(Locale.ENGLISH).intern(), ARGS);
    }
    ...
    public void execute(Action action, Player player, Object... objects) {
        ...
        storage.clearSlotWithRestrictions((Integer) pageObj, (Integer) slotObj);
    }
}
